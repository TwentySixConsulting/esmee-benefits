    ...
    trends: {
      ...
      steps: [
        { selector: "[data-page='trends'] .efb-intro", placement: "bottom",
          ...
          html: "The rest of the report measures Esm&eacute;e against the market as it is. This page is the opposite: what comparable funders offer that Esm&eacute;e does not, and where the sector is heading." },
